...
-----------------------------------------------------------
-- ATTRIBUTION DES PRIVILÈGES AUX ADMINISTRATEURS
-----------------------------------------------------------

-- Attribution des privilèges aux administrateurs de Cergy
-- GRANT SELECT ON GLOBAL_VIEW_STATE_ASSET_USER TO CY_TECH_CERGY;
-- GRANT SELECT ON GLOBAL_VIEW_NETWORK_USAGE TO ROLE_ADMIN_CERGY;
-- GRANT SELECT ON GLOBAL_VIEW_TICKET_STATISTICS TO ROLE_ADMIN_CERGY;
-- GRANT SELECT ON GLOBAL_VIEW_UNRESOLVED_TICKETS TO ROLE_ADMIN_CERGY;
-- GRANT SELECT ON GLOBAL_VIEW_STUDENTS_INFO TO ROLE_ADMIN_CERGY;
-- GRANT SELECT ON GLOBAL_VIEW_ASSET_TO_REPLACE TO ROLE_ADMIN_CERGY;

-- Attribution des privilèges aux administrateurs de Pau
-- GRANT SELECT ON GLOBAL_VIEW_STATE_ASSET_USER TO ROLE_ADMIN_PAU;
-- GRANT SELECT ON GLOBAL_VIEW_NETWORK_USAGE TO ROLE_ADMIN_PAU;
-- GRANT SELECT ON GLOBAL_VIEW_TICKET_STATISTICS TO ROLE_ADMIN_PAU;
-- GRANT SELECT ON GLOBAL_VIEW_UNRESOLVED_TICKETS TO ROLE_ADMIN_PAU;
-- GRANT SELECT ON GLOBAL_VIEW_STUDENTS_INFO TO ROLE_ADMIN_PAU;
-- GRANT SELECT ON GLOBAL_VIEW_ASSET_TO_REPLACE TO ROLE_ADMIN_PAU;